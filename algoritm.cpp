...
//требуема€ ширина дл€ обсчета 20 отсчетов
...
//требуема€ ширина дл€ обсчета 24 отсчета
...
u16 i_a1=0,i_a2=0,i_a3=0;
 ...
 if ( (time_0_1>=TIME_MIN) && (time_0_1<=TIME_MAX) ) i_t1=1; //врем€ 0-1 норма
 if ( (time_1_2>=TIME_MIN) && (time_1_2<=TIME_MAX) ) i_t2=1; //врем€ 1-2 норма
 if ( (time_0_2>=TIME_MIN) && (time_0_2<=TIME_MAX) ) i_t3=1; //врем€ 0-2 норма
 else if ( (time_0_2>=TIME_MIN) && (time_0_2<=(TIME_MAX*2) ) i_t4=1; //врем€ 0-2 возможно двойное
                ...
                if (i_a1){ //соотношение амплитуд 0 и 1 нормальное
                        ...
                        if (i_p3){ //по третьему импульсу
                                ...
                                if (i_a2) {//соотношение амплитуд 1 и 2 нормальное
                                        ...
                                        if (i_t1){ //провер€ем временные интервалы 0-1 (грубо)

                                                if (i_t2){ //провер€ем временные интервалы 1-2 (грубо)
                                                ...
                                                if (i_t2){ //провер€ем временные интервалы 1-2
